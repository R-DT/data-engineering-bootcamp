...
def test_database_connector_successful_connection(mocker):
...
def test_database_session_rollback_on_failure(mocker):
    ...
    # Verify that rollback was explicitly triggered to keep data safe
